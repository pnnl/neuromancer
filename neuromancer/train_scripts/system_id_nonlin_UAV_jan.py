...
def parse():
    ...
    model_group.add_argument('-sigma_min', type=float, default=0.95, help='Lower bound on eigenvalues/singular values of factorized linear maps.')
...
if __name__ == '__main__':
    ...
    dynamics_model.fy = slim.maps[args.linear_map_fy](nx, dataset.dims['Y'][-1], sigma_max=0.99, sigma_min=1.0)
