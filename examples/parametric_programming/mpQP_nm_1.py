...
if __name__ == "__main__":
    ...
    nm_con_viol_mean = eval_constraints(x_nm, y_nm, p1)
    ...
    solver_con_viol_mean = eval_constraints(x_solver, y_solver, p1)
