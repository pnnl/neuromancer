...
def get_node(nx, nu, args):
    integrator = MultipleShootingEuler(nx, nu, args.hsize, args.nlayers, torch.tensor(args.ts))
...
if __name__ == "__main__":
    ...
    logout = ['lossN', 'loss1', 'fd', 'mse_test', 'mae_test', 'r2_test', 'eval_mse']
