...
+ New feature: Showing how NeuroMANCER toolbox can be used to solve a parametric quadratic program and implement a learned operator splitting method as a final layer to improve solutions (proximal operator method)
