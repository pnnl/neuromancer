...
def parse():
    ...
    data_group.add_argument('-nsteps', type=int, default=5,
    ...
    model_group.add_argument('-n_layers', type=int, default=1,
    ...
    model_group.add_argument('-estimator_input_window', type=int, default=5,
    ...
    model_group.add_argument('-linear_map', type=str, choices=list(slim.maps.keys()),
                             default='linear')
    model_group.add_argument('-nonlinear_map', type=str, default='basislinear',
...
#
#             for c in comb:
#                 torch.index_select(data[key], 0, indices)
#                 index += 1
#                 nlin_data[key+str(index)] = torch.mul(data[key][:, :, c[0]], data[key][:, :, c[1]]).to(self.device)
#         return nlin_data
