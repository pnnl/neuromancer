...
% LQR controller design - very sensitive to Q and R tuning
Q = 35e4*Cd'*Cd;
R = 1*eye(nu);
N = zeros(nx,nu);
...
%     initial states
    ...
    %     uncertainties
        ...
        %   LQR ctrl action computed via state feedback gain K and precompensated with Nbar 
        uopt = -Nbar*ref-K*xt;   
