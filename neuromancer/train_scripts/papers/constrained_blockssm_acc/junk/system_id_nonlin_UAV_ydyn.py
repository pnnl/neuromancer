...
def parse():
    ...
    model_group.add_argument('-fyu', default='mlp', choices=['mlp', 'rnn', 'pytorch_rnn', 'linear', 'residual_mlp'], help='direct input-output dynamics')
...
if __name__ == '__main__':
    ...
    dynamics_model = {'blackbox': dynamics.blackbox,
                      ...
                      'hw': dynamics.hw}[args.ssm_type](args.bias, linmap, nonlinmap,
                                                        ...
                                                        xou=xou, xod=xod, xoe=xoe, xoyu=xoyu, fyu=fyu)
