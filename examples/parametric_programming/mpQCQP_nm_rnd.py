"""
Tutorial script for formulating and solving multiparametric
quadratically  constrained quadratic programs (mpQCQP)
using Neuromancer's data-driven differentiable parametric optimization (D3PO) approach

mpLP problem formulation:
    J(\Theta) = min_x  x^T P x + c^T x
                s.t. x^T H x + q^T x + r \le 0
                      \Theta \in F
...
Further reading:
    https://www.mit.edu/~parrilo/cdc03_workshop/03_qcqp_2003_12_07_01_screen.pdf
"""
