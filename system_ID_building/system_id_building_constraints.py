...
if __name__ == "__main__":
    """
    Script for recreating system identification results from the paper
    https://www.sciencedirect.com/science/article/pii/S0378778821002760
    """

    # To change the hyperparameters see arg.py
