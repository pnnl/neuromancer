...
Note that this script still takes about ~90 minutes to run on 2 GPUs (when num_vars = 5) Most of that time is "setup time"/preprocessing.
...
def main(): 
        num_vars = 5 # please change this to <=4 in order to run quickly
        ...
        lit_trainer = LitTrainer(epochs=10, accelerator="gpu", devices=[1,2], strategy="ddp")
